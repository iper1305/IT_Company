...
public class Designer extends Employee implements Closable, Createble, Cancelable {

    public Designer(int experience, String position, Release release, MeetingCalendar meetingCalendar) {
