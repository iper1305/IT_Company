...
public class QA extends Employee implements Closable, Createble, Cancelable {

    public QA(int experience, String position, Release release, MeetingCalendar meetingCalendar) {
